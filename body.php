						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Gaming</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">APPLE</a></li>
									<li><a data-toggle="tab" href="#tab2">IPhone14Pro</a></li>
									<li><a data-toggle="tab" href="#tab2">IPhone14 Pro Max</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 1 AND 22";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/iphone14pro.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">$990.00 <del class="product-old-price">$1000.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/iphone14promax.jpg" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
